import './index.css';
import profileImage from "./components/img/IMG_7952 2.png"
          ...
          >
                <li>
                  ...
                  <ul role="list" className="mt-6 flex gap-x-6 justify-center">
                    <li>
                      <a href="https://twitter.com/isacholstad7" className="text-gray-400 hover:text-gray-500">
                    ...
                    <li>
                      <a href="https://github.com/IsacHolstad" className="text-gray-400 hover:text-gray-500">
                    ...
                    <li>
                      <a href="https://www.linkedin.com/in/isac-holstad-30815121b/" className="text-gray-400 hover:text-gray-500">
